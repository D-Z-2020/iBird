    ...
    // 鸟类 2: House sparrow
{
    ...
    description: `
    One of the world’s most successful introduced species, the house sparrow is found from sub-Arctic to sub-Tropical regions everywhere, 
    except Western Australia and some small islands. 
    It lives mostly in close association with man. This ubiquity has led to many studies of it as a pest and of its physiology, 
    energetics, behaviour, genetics and evolution. There is even a scientific journal devoted to work on the house sparrow and other Passer species.
    `,
    rarity: 1, // 根据您的排名，您可以为每种鸟类设置不同的 rarity 值
    images: [
        "https://nzbirdsonline.org.nz/sites/all/files/IMG_5492.JPG", // 插入 House sparrow 的图像 URL
...
// 鸟类 3: Rock pigeon
{
    ...
    habitat: "Urban areas",
    description: `
    The rock pigeon is a familiar species to most New Zealanders, given its distribution from Northland to Southland, 
    and being present in both urban and rural areas. While rural birds are usually quite timid, flying off at close approach,
     urban birds are often quite the opposite, walking about at one’s feet and even alighting on people to take food.
    It is a gregarious species, often roosting, commuting and foraging in flocks.
    `,
    rarity: 1, // 根据您的排名，您可以为每种鸟类设置不同的 rarity 值
    images: [
        "https://nzbirdsonline.org.nz/sites/all/files/Rock%20Pigeon_Mt%20Cook_Oct16_Scott%20Brooks_IMG_2337.jpg", // 插入 Rock pigeon 的图像 URL
...
// 鸟类 4: Eurasian blackbird
{
    ...
    description: `
    The Eurasian blackbird was introduced to New Zealand, and is now our most widely distributed bird species.
     Adult males are entirely black apart from their yellow bill and eye-ring. Females and juveniles are mostly dark brown,
      slightly mottled on the belly. Blackbirds are common in a wide range of habitats including suburban gardens, farmland, woodlands and indigenous forests. 
      Their song is given from winter to summer, with the singing male usually perched on a high branch, tree top or power line. 
      They sing most in the early morning and evening. Blackbirds feed mostly on the ground on earthworms, snails, and insects.
       They also take berries while perched in foliage.
    `,
    rarity: 1, // 根据您的排名，您可以为每种鸟类设置不同的 rarity 值
    images: [
        "https://nzbirdsonline.org.nz/sites/all/files/1200593Turdus-merula_9973.jpg", // 插入 Eurasian blackbird 的图像 URL
...
// 鸟类 5: Chaffinch
{
    ...
    Chaffinches are the commonest and most widespread of New Zealand’s introduced finches, and are found in a wide range of habitats from sea-level to 1400 m.
     They are self-introduced to many off-shore islands. Chaffinches frequently visit suburban gardens, 
     especially in winter, and are often seen feeding with house sparrows and silvereyes around bird-tables, 
     on lawns and in parks. The sexes may segregate into separate flocks in winter, especially males; hence the specific name of coelebs (bachelor).
    `,
    rarity: 1, 
    images: [
        "https://nzbirdsonline.org.nz/sites/all/files/2L1A1774_0.jpg", // 插入 Chaffinch 的图像 URL
...
// 鸟类 6: New Zealand pigeon
{
    ...
    description: `
    A large arboreal pigeon with a red bill, feet and eyes. The upperparts are blue-green with purple-bronze iridescence on the neck,
     mantle and wing coverts, and the underparts are white with a sharp demarcation between the white and blue-green on the upper breast.
    `,
    rarity: 1,
    images: [
...
// 鸟类 7: European goldfinch
{
    ...
    description: `
    Goldfinches are small finches with flashes of bright yellow and red, common in open country throughout New Zealand. 
    Introduced from Britain 1862-1883, their tinkling calls contribute to the collective noun “a charm of goldfinches”.
     They are mainly seed-eaters, and often gather in flocks to feed on thistle seed. Goldfinches frequently stray to outlying island groups, 
     and are resident on the Chatham Islands.
    `,
    rarity: 1,
    images: [
...
// 鸟类 8: European greenfinch
{
    ...
    description: `
        The European greenfinch, also known as Greenfinch, is a small bird found in woodlands and parks.
        It is known for its green plumage and distinctive call. European greenfinches primarily feed on seeds and insects.
        They are commonly seen in various parts of the world, including New Zealand.
    `,
    rarity: 10,
    images: [
        "Image URL 1",
...
// 鸟类 9: Song thrush
{
    ...
    habitat: "Forests, gardens",
    description: `
    The song thrush is easily recognised by its speckled brown-on-cream breast. It is often heard before it is seen,
     as it is one of the main songsters of suburban New Zealand, with a very long singing season. Thrushes sing from a high branch,
      at the top of a tree or on power poles and lines. Their distinctive song comprising a wide range of notes,
       with each phrase typically repeated 2-3 times in succession. 
    They are common throughout mainland New Zealand and nearby offshore islands, also Stewart Island, Chatham Islands, 
    Snares Islands and Auckland Islands.
    `,
    rarity: 1,
    images: [
...
{   
    ...
    description:`
    The black-and-white Australian magpie is a common and conspicuous inhabitant of open country throughout much of New Zealand.
    It was introduced from Australia and Tasmania by Acclimatisation Societies between 1864 and 1874, mainly to control insect pests.
    There are three subspecies; the black-backed, and two white-backed forms, with white-backed birds predominating in most parts of New Zealand.
    Some authorities group the Australian magpie with butcherbirds in the genus "Cracticus."  `,
    rarity: 1,
    images: [
...
// 鸟类 10: Tui
{
    ...
    habitat: "Forests, gardens",
    description: `
    Tui are boisterous, medium-sized, common and widespread bird of forest and suburbia – unless you live in Canterbury.
     They look black from a distance, but in good light tui have a blue, green and bronze iridescent sheen, and distinctive white throat tufts (poi).
      They are usually very vocal, with a complicated mix of tuneful notes interspersed with coughs,
     grunts and wheezes. In flight, their bodies slant with the head higher than the tail,
      and their noisy whirring flight is interspersed with short glides.
    `,
    rarity: 1,
    images: [
    ...
    questions: [
        ...
        {
            question: "What do Tuis primarily eat?",
...
// 鸟类 11: Common myna
{
    ...
    It was introduced to many Pacific lands, including New Zealand, usually to combat invertebrate pests. 
    Mynas are large, conspicuous passerines. A shiny black head and shoulder plumage merges into vinous 
    brown for the remainder of the body and a large patch of white is flashed from each wing during flight. 
    `,
    rarity: 1,
    images: [
...
// 鸟类 12: Yellowhammer
{
    ...
    description: `
        ...
        Yellowhammers feed on a variety of seeds and invertebrates. They are frequently seen feeding on the seeds in hay fed to livestock, 
        and also on newly-sown grass seed.
    `,
    rarity: 1,
    images: [
...
// 鸟类 13: Dunnock
{
    ...
    Dunnocks are small brown songbirds that were introduced from England into multiple regions of New Zealand between 1865 and 1896.
     They are a common sight in urban gardens and open country in southern New Zealand, but are scarcer in the northern North Island. 
     The drab appearance of dunnocks is compensated by their stunningly complex breeding behaviours.
    `,
    rarity: 2,
    images: [
...
// 鸟类 14: Red-billed Gull
{
    ...
    description: `
    The red-billed gull is the commonest gull on the New Zealand coast. Except for a colony at Lake Rotorua, 
    it rarely is found inland. It is commonly seen in coastal towns, garbage dumps and at fish processing facilities. 
    Immature adults are often confused with the closely related black-billed gull. Recently the largest colonies in 
    different parts of New Zealand have exhibited a marked decline in numbers.
    `,
    rarity: 2,
    images: [
...
// 鸟类 15: Southern black-backed gull
{
    ...
    habitat: "Coastal areas",
    description: `
        The southern black-backed gull, also known as the kelp gull, is a large gull species with dark plumage.
        It primarily feeds on fish and invertebrates and is commonly found in coastal areas.
        Southern black-backed gulls are known for their scavenging behavior and are often seen near fishing boats.
    `,
    rarity: 2,
    images: [
...
// 鸟类 16: Eurasian skylark
{
    ...
    habitat: "Grasslands, farmlands",
    description: `
    Eurasian skylarks are more often heard than seen. Their small size and streaked brown plumage make them difficult to see on the ground, 
    but their vibrant aerial song quickly reveals their presence, a song that has inspired poets and musicians for centuries. 
    Skylarks were introduced into New Zealand from England between 1864 and 1879, when more than 1000 birds were released.
     Birds from New Zealand were released in turn on the Hawaiian Islands in 1870, supplementing a population introduced there from England five years earlier.
    `,
    rarity: 2,
    images: [
...
// 鸟类 17: White-faced heron
{
    ...
    description: `
    The white-faced heron is New Zealand's most common heron, despite being a relatively new arrival to this country.
     It is a tall, elegant, blue-grey bird that can be seen stalking its prey in almost any aquatic habitat,
      including damp pasture and playing fields. Because it occupies space also shared with people it is usually well habituated to their presence, 
      and may allow close approach.
    `,
    rarity: 2,
    images: [
...
// 鸟类 18: Spur-winged plover
{
    ...
    description: `
    The New Zealand spur-winged plover population has a unique conservation trajectory among our native bird species. 
    In just over 80 years since the first breeding record, it has gone from a fully protected native to having that protection removed in 2010. 
    First recorded breeding near Invercargill in 1932, it subsequently spread northwards through the country, becoming established in Northland in the 1980s
    `,
    rarity: 2,
    images: [
...
// 鸟类 19: Welcome swallow
{
    ...
    Their flight is circular and darting in style, and they may be seen singly, in pairs or in flocks. Flocks often perch en masse, 
    lined up on fences or power lines. 
    `,
    rarity: 2,
    images: [
...
// 鸟类 20: New Zealand fantail
{
    ...
    habitat: "Forests, gardens",
    description: `
    The fantail is one of New Zealand’s best known birds, with its distinctive fanned tail and loud song, 
    and particularly because it often approaches within a metre or two of people. Its wide distribution and habitat preferences,
     including frequenting well-treed urban parks and gardens, means that most people encounter fantails occasionally.
...
// 鸟类 21: Eastern rosella
{
    ...
    description: `
    The eastern rosella is a brightly coloured, broad-tailed parakeet native to south-eastern Australia.
     It was introduced to New Zealand in the early 1900s, and is now common over much of the North Island, 
     with a smaller population centred on Dunedin. They typically move around the landscape in pairs or small flocks, 
     often given away by their noisy chatter or loud, in-flight alarm call.
    `,
    rarity: 3,
    images: [
...
// 鸟类 22: Grey warbler
{
    ...
    description: `
    The grey warbler is New Zealand’s most widely distributed endemic bird species, 
    based on the number of 10 x 10 km grid squares it occupied over the whole country in a 1999-2004 survey.
     It vies with rifleman for the title of New Zealand’s smallest bird, with both weighing about 6 g. 
     The title usually goes to rifleman, based on its shorter tail and therefore shorter body length
    `,
    rarity: 3,
    images: [
...
// 鸟类 23: Bellbird
{
    ...
    habitat: "Forests, gardens",
    description: `
    Bellbirds are the most widespread and familiar honeyeater in the South Island, 
    and are also common over much of the North Island. 
    Their song is a welcome sound in mainland forests that otherwise may have little native bird song. 
    Although they have a brush-like tongue which is used to reach deeply into flowers to reach nectar,
     bellbirds also feed on fruits and insects. In feeding on nectar they play an
      important ecological role in pollinating the flowers of many native trees and shrubs.
    `,
    rarity: 4,
    images: [
...
// 鸟类 24: North Island robin
{
    ...
    habitat: "Forests, shrublands",
    description: `
    The North Island robin occurs in forest and scrub habitats. It can be recognised by its erect stance and relatively long legs,
     and spends much time foraging on the ground. It is a territorial species, males in particular inhabiting the same patch of mainland 
     forest of 1-5 ha throughout their lives. Male are great songsters, particularly bachelors, singing loudly and often for many minutes 
     at a time. Where robins are regularly exposed to people, such as along public walking tracks, they become quite confiding,
      often approaching to within a metre of a person sitting quietly. Naïve juveniles will sometimes stand on a person’s boot.
    `,
    rarity: 4,
    images: [
...
// 鸟类 25: Shining cuckoo
{
    ...
    habitat: "Forests, gardens",
    description: `
    The shining cuckoo (shining bronze-cuckoo in Australia) is a summer migrant to New Zealand.
     It is common throughout New Zealand but it is small and cryptically-coloured and so is more often heard than seen.
      It has a distinctive whistling call. Two intriguing aspects of its life history are its brood-parasitic habits and the 
      long annual trans-oceanic migration. The New Zealand subspecies breeds only in New Zealand (including Chatham Islands) 
      but other subspecies breed in southern Australia, Vanuatu, New Caledonia and on Rennell and Bellona Islands (Solomon Islands).
    `,
    rarity: 4,
    images: [
...
// 鸟类 26: Black-fronted tern
{
    ...
    They breed on the braided rivers of the eastern South Island, dispersing to coastal areas after breeding; 
    it is during this time that some birds are seen in the North Island. The black-fronted tern is an attractive 
    and highly distinctive bird in breeding plumage, with the slate grey plumage contrasting with the black cap and bright orange bill.
     Juveniles and immature birds may be confused with other vagrant tern species but all are easily separable.
    `,
    rarity: 5,
    images: [
...
// 鸟类 27: Southern brown kiwi
{
    ...
    description: `
    The Stewart Island tokoeka is the largest of the kiwi. Fiordland tokoeka are also very large, but Haast birds are smaller. 
    Widespread in forest, scrub, tussock grasslands and subalpine zones of the south-western South Island and on Stewart Island.
    Flightless, with tiny vestigial wings and no tail. Generally nocturnal, therefore more often heard than seen, 
    except on Stewart Island where birds often forage during the day. 
    `,
    rarity: 5,
    images: [
...
// 鸟类 28: New Zealand swan
{
    name: "New Zealand swan",
    maoriName: "Matapu", 
    scientificName: "Cygnus atratus sumnerensis",
    otherNames: ["pouwa"],
    ...
    habitat: "Lakes, rivers",
    description: `
        The New Zealand swan is a large waterbird known for its graceful appearance.
        It primarily feeds on aquatic plants and is commonly found in lakes and rivers.
        New Zealand swans are known for their elegant necks and distinctive calls.
    `,
    rarity: 30,
    images: [
    ...
    questions: [
        ...
        },
        {
            ...
            answers: ["Cygnus atratus", "Gymnorhina tibicen", "Sparrowus passer"],
            correctAnswer: "1"
        },
        {
...
// 鸟类 29: Stilwell’s penguin
{
    ...
    description: `
    Stilwell’s penguin is one of the earliest penguins known. Fossils were recovered from 62.5-60-million-year-old (late early to middle Paleocene) 
    marine deposits of the Takatika Grit, at Maunganui Beach, Chatham Island (Wharekauri / Rēkohu).
    `,
    rarity: 6,
    images: [
    ...
    questions: [
        {
            question: "What was the estimated height of Stilwell's penguin compared to modern king penguins?",
            answers: ["Less than 0.5 meters", "About 1 meter", "More than 2 meters"],
            correctAnswer: "2"
        },
        {
            question: "What type of environment did Stilwell's penguin inhabit around 60 million years ago?",
            answers: ["Arctic region", "Sub-tropical to tropical region", "Deep oceans"],
            correctAnswer: "2"
        },
        {
            question: "What was the main adaptation in Stilwell's penguin's skeleton that allowed it to be proficient at underwater diving?",
            answers: ["Stiff and flipper-like wings", "Short and wide tarsometatarsus", "Long and slender bill"],
            correctAnswer: "2"
        },
        {
            question: "How did Stilwell's penguin use its tarsometatarsus bone in its daily life?",
            answers: ["As a tool for digging nests", "As a rudder while swimming", "To catch insects"],
            correctAnswer: "2"
        },
        {
            question: "What is unique about Stilwell's penguin's tarsometatarsus compared to similarly-sized ancient penguins?",
            answers: ["It was much longer", "It had a hydrodynamic body shape", "It was shorter"],
            correctAnswer: "3"
        },
        {
            question: "What does the genus name 'Kupoupou' mean in Te Re Moriori?",
            answers: ["Little penguin", "Diving bird", "Ancient penguin"],
            correctAnswer: "2"
        },
        {
            question: "Who is the specific epithet 'stilwelli' named after?",
            answers: ["Sir Edmund Hillary", "Jeffrey D. Stilwell", "Jacinda Ardern"],
            correctAnswer: "2"
        }
